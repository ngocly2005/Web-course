...
import "./style-btn-filter.css";
import { CCategory } from "../common/enum";

const BtnFilter = ({ setSelecCategory, setRatingRanges, setMinStudents }) => {
  ...
  const applyFilters = () => {
    // truyền danh sách khoảng rating cho parent
          ...
          <div className="modal-content">
            ...
            <div>
              ...
              >
                ...
                <option value={CCategory.KyNangGiaoTiep}>
                  Kỹ năng giao tiếp
                </option>
                <option value={CCategory.KinhdoanhMarketing}>
                  Kinh doanh & Marketing
                </option>
                <option value={CCategory.thietKeSangTao}>
                  Thiết kế sáng tạo
                </option>
                <option value={CCategory.amNhacNgheThuat}>
                  Âm nhạc & Nghệ thuật
                </option>
                <option value={CCategory.sucKhoeDoiSong}>
                  Sức khỏe & Đời sống
                </option>
                <option value={CCategory.phatTrienCaNhan}>
                  Phát triển cá nhân
                </option>
              </select>
            </div>
            ...
            {/* Số người đăng ký */}
            {/* <div>
              <h3>Lọc theo số người đăng ký:</h3>
              <input
                type="number"
                min="0"
                value={localMinStudents}
                onChange={(e) => setLocalMinStudents(Number(e.target.value))}
              />
            </div> */}

            <button onClick={applyFilters} className="style-filter-1 ">
              Lọc
            </button>
          </div>
        </div>
